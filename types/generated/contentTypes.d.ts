...
export interface ApiEventDetailEventDetail extends Struct.SingleTypeSchema {
...
export interface ApiFoodAndDrinksFoodAndDrinks extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'foodAndDrinks';
    pluralName: 'food-and-drinkss';
    singularName: 'food-and-drinks';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    drinksList: Schema.Attribute.RichText;
    foodList: Schema.Attribute.RichText;
    lehmannsButterbroteInfo: Schema.Attribute.RichText;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPackingListPackingList extends Struct.SingleTypeSchema {
  collectionName: 'packing_lists';
  info: {
    displayName: 'Packing List';
    pluralName: 'packing-lists';
    singularName: 'packing-list';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    listContent: Schema.Attribute.RichText;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::packing-list.packing-list'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiTravelInformationTravelInformation
  extends Struct.SingleTypeSchema {
  collectionName: 'travel_informations';
  info: {
    displayName: 'Travel Information';
    pluralName: 'travel-informations';
    singularName: 'travel-information';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    carDirections: Schema.Attribute.RichText;
    carInfoList: Schema.Attribute.RichText;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descriptionArrival: Schema.Attribute.RichText;
    lat: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::travel-information.travel-information'
    > &
      Schema.Attribute.Private;
    long: Schema.Attribute.String;
    mapsUrl: Schema.Attribute.String;
    mapTravelInfo: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    publishedAt: Schema.Attribute.DateTime;
    shuttleTimes: Schema.Attribute.RichText;
    trainShuttleInfo: Schema.Attribute.RichText;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
